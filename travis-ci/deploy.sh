...
mkdir -p $UPDATESITE_PROJECT/$DEPLOYMENT_FOLDER/$SUB_UPDATESITE_NAME$VERSION_SUFFIX
cp -r $GENERATED_UPDATESITE_FOLDER/* $UPDATESITE_PROJECT/$DEPLOYMENT_FOLDER/$SUB_UPDATESITE_NAME$VERSION_SUFFIX
